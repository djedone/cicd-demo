...
def test_create_deployment(client):
    ...
    response = client.post("/api/deployments", 
                          json={"version": "1.0.0", "environment": "test"})
...
def test_data_integrity(client, app):
    ...
    with app.app_context():
        ...
        response = client.post("/api/deployments", 
                              json={"version": "3.0.0", "environment": "production"})
